...
class BusViewController: UIViewController {
    ...
    var busViewCell: CustomBusTableViewCell!
    ...
    override func viewDidLoad() {
        ...
        let nib = UINib(nibName: "CustomBusTableViewCell", bundle: nil)
    ...
    @objc func customShowPopUp() {
        ...
        self.showAlert(title: "Error", message: "1 taneden fazla koltuk seçemezsiniz.")
    ...
    @objc func emptySeat() {
        self.showAlert(title: "Error", message: "Koltuk seçmediniz.")
    }
...
extension BusViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! CustomBusTableViewCell
